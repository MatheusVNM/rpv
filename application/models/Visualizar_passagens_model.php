...
class Visualizar_passagens_model extends CI_Model
{
    ...
    public function getPassagensTotal()
    {
        ...
        COUNT(comprapassagem.comprapassagem_id), alocacaointermunicipal.alocacaointermunicipal_data_hora_inicio FROM onibus JOIN 
        ...
        comprapassagem.comprapassagem_cadeira = 
    ...
    public function pegarTrajetoFimDeTodas()
    {
        ...
        comprapassagem on comprapassagem.comprapassagem_cadeira = ocupacaocadeira.ocupacaocadeira_id";
        $result = $this->db->query($sql);
        if (!$result) {
            $retorno['success'] = false;
            $retorno['error'] = $this->db->error();
    ...
    {
        $sql = "SELECT COUNT(comprapassagem.comprapassagem_tipo_passagem) FROM 
        onibus JOIN alocacaointermunicipal on alocacaointermunicipal.alocacaointermunicipal_onibus
         ...
         cidade.cidade_id = trajetointerurbano.trajetointerubano_cidadeInicio JOIN ocupacaocadeira
          ...
          alocacaointermunicipal.alocacaointermunicipal_id JOIN comprapassagem on 
          comprapassagem.comprapassagem_cadeira = ocupacaocadeira.ocupacaocadeira_id
           JOIN tipo_passagem on tipo_passagem.tipo_passagem_id = 
           comprapassagem.comprapassagem_tipo_passagem WHERE tipo_passagem.tipo_passagem_id = +$id";
        $result = $this->db->query($sql);
        if (!$result) {
            $retorno['success'] = false;
            $retorno['error'] = $this->db->error();
    ...
    {
        $sql = "SELECT tipo_passagem.tipo_passagem_nome_tipo, COUNT(comprapassagem.comprapassagem_tipo_passagem), 
        comprapassagem.comprapassagem_valor_compra, alocacaointermunicipal.alocacaointermunicipal_data_hora_inicio FROM 
        ...
        ocupacaocadeira.ocupacaocadeira_alocacaointermunicipal = alocacaointermunicipal.alocacaointermunicipal_id JOIN 
        comprapassagem on comprapassagem.comprapassagem_cadeira = ocupacaocadeira.ocupacaocadeira_id JOIN 
        tipo_passagem on tipo_passagem.tipo_passagem_id = comprapassagem.comprapassagem_tipo_passagem WHERE 
