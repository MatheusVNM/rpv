    ...
    <div class="d-flex w-100" id="wrapper">
        ...
        <div class="navbar-dark border-right sidebar shown" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?= site_url('dashboard/concessoes') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-paper-plane-o mr-1"></i> Gerenciar Concessoes</a>
