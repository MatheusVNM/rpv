        ...
        <div class="navbar-dark border-right sidebar shown" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <?php if ($this->session->userdata('level') === 'adm') : ?>
                    <a href="<?= site_url('dashboard/categorias/passageiros') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-group mr-1"></i> <i class="hvr-icon text-warning fa fa-exclamation-triangle mr-1"> </i>Gerenciar Categorias de Passageiros</a>
                    ...
                    <a href="<?= site_url('dashboard/formas_pagamentos') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-money mr-1"></i> Gerenciar Formas de pagamento</a>
                    <a href="<?= site_url('dashboard/tarifas/encomendas') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-suitcase-rolling mr-1"></i> Gerenciar Tarifa Encomenda</a>

                <?php elseif ($this->session->userdata('level') === 'admlocal') : ?>
                    <a href="<?= site_url('dashboard/tarifas/municipal') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-money mr-1"></i> <i class="hvr-icon text-warning fa fa-exclamation-triangle mr-1"></i>Gerenciar Tarifas</a>
