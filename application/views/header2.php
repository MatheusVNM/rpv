        ...
        <div class="navbar-dark border-right sidebar shown" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <?php if ($this->session->userdata('level') === 'adm') : ?>
                    ...
                    <a href="<?= site_url('dashboard/segurosFuncionarios') ?>" class="list-group-item list-group-item-action bg-light hvr-sweep-to-right hvr-icon-grow"><i class="hvr-icon fa fa-archive mr-1"></i> Gerenciar Seguros de Funcionarios</a>
